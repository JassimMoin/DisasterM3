...
- **Operating System:** Linux (Ubuntu 20.04+ recommended). vLLM does not support Windows.
- **GPU:** NVIDIA GPU with CUDA support (required for vLLM inference)
- **Python:** 3.9 or higher
- **Dataset:** Must be requested separately via [this form](https://forms.gle/APQpmyuThh28HsJdA)
